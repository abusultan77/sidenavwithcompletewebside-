                    ...
                    <div class="marquee__group">
                      <div className="trendingcard wow animate__animated animate__fadeInLeft animate__slow">
                        ...
                        <div className="trendingcardtext">
                          <h6 className="treandingcardhead">#1</h6>
                      ...
                      <div className="trendingcard wow animate__animated animate__fadeInLeft animate__slow">
                        ...
                        <div className="trendingcardtext">
                          ...
                          <p className="trendingcardpara">Yuliverse</p>
                        </div>
                      </div>
                      <div className="trendingcard wow animate__animated animate__fadeInLeft animate__slow">
                        <div className="tendingcardimg">
                          <img src="\Assets\home-assets\Yuliverse.png" alt="trendingcardinnerimg" className="trendingcardinnerimg" />
                          <div className="exchangeimg">
                            <img src="\Assets\home-assets\exchangeimg.png" alt="innerexchangeimg" className="innerexchangeimg" />
                          </div>
                        </div>
                        <div className="trendingcardtext">
                          <h6 className="treandingcardhead">#3</h6>
                          <p className="trendingcardpara">BinaryX</p>
                        </div>
                      </div>
                      <div className="trendingcard wow animate__animated animate__fadeInLeft animate__slow">
                        <div className="tendingcardimg">
                          <img src="\Assets\home-assets\BinaryX.png" alt="trendingcardinnerimg" className="trendingcardinnerimg" />
                          <div className="exchangeimg">
                            <img src="\Assets\home-assets\exchangeimg.png" alt="innerexchangeimg" className="innerexchangeimg" />
                          </div>
                        </div>
                        <div className="trendingcardtext">
                          <h6 className="treandingcardhead">#4</h6>
                          <p className="trendingcardpara">Planet IX</p>
                        </div>
                      </div>
                      <div className="trendingcard wow animate__animated animate__fadeInLeft animate__slow">
                        <div className="tendingcardimg">
                          <img src="\Assets\home-assets\Planet IX.png" alt="trendingcardinnerimg" className="trendingcardinnerimg" />
                          <div className="exchangeimg">
                            <img src="\Assets\home-assets\exchangeimg.png" alt="innerexc hangeimg" className="innerexchangeimg" />
                          </div>
                        </div>
                        <div className="trendingcardtext">
                          <h6 className="treandingcardhead">#5</h6>
                          <p className="trendingcardpara">Kryptomon</p>
                        </div>
                      </div>
                      <div className="trendingcard wow animate__animated animate__fadeInLeft animate__slow">
                        <div className="tendingcardimg">
                          <img src="\Assets\home-assets\Kryptomon.png" alt="trendingcardinnerimg" className="trendingcardinnerimg" />
                          <div className="exchangeimg">
                            <img src="\Assets\home-assets\exchangeimg.png" alt="innerexchangeimg" className="innerexchangeimg" />
                          </div>
                        </div>
                        <div className="trendingcardtext">
                          <h6 className="treandingcardhead">#6</h6>
                          <p className="trendingcardpara">The Sandbox</p>
                        </div>
                      </div>
                      <div className="trendingcard wow animate__animated animate__fadeInLeft animate__slow">
                        <div className="tendingcardimg">
                          <img src="\Assets\home-assets\Thesandbox.png" alt="trendingcardinnerimg" className="trendingcardinnerimg" />
                          <div className="exchangeimg">
                            <img src="\Assets\home-assets\exchangeimg.png" alt="innerexchangeimg" className="innerexchangeimg" />
                          </div>
                        </div>
                        <div className="trendingcardtext">
                          <h6 className="treandingcardhead">#7</h6>
                          <p className="trendingcardpara">IguVerse</p>
                        </div>
                      </div>
                      <div className="trendingcard wow animate__animated animate__fadeInLeft animate__slow">
                        <div className="tendingcardimg">
            ...
            <section className="currpresale">
              ...
              <div className="maintabs">
                ...
                <FormControl fullWidth>
                    <InputLabel className='formargin' id="demo-simple-select-label">Filter by</InputLabel>
                  ...
                  <FormControl fullWidth>
                    <InputLabel className='formargin' id="demo-simple-select-label">Pool Type</InputLabel>
                  ...
                  <FormControl fullWidth>
                    <InputLabel className='formargin' id="demo-simple-select-label">Sort by</InputLabel>
                  ...
                  <FormControl fullWidth>
                    <InputLabel className='formargin' id="demo-simple-select-label">Chain</InputLabel>
                    ...
                    <div className="currpresaleupper">
                      <div className="currpresaleupperleft">
                        <div className="currpresalecardimg">
                          <img src="\Assets\home-assets\RiseofElves.png" alt="trendingcardinnerimg" className="currpresalecardinnerimg" />
                          <div className="exchangeimg">
                            <img src="\Assets\home-assets\exchangeimg.png" alt="innerexchangeimg" className="innerexchangeimg" />
                          </div>
                        </div>
